...
# Step 6: Analyze the corpus and find concordances for 'zaman' and its forms
window_size = 5  # Define the window size: 5 words to the left and right
for i, word in enumerate(tokens):
    if is_zaman_form(word) and is_valid_word(word):
...
with open('zaman_concordance.csv', mode='w', newline='', encoding='utf-8') as file:
